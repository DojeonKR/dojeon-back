...
export class PracticeController {
  ...
  @ApiOperation({
    summary: '토픽 문제 목록',
    description: '특정 토픽의 연습 문제 목록을 반환합니다.',
  })
        ...
        questions: [
          {
            id: 1,
            type: 'MCQ',
            questionText: '다음 중 "안녕하세요"의 올바른 의미는?',
  ...
  @ApiOperation({
    summary: '연습 문제 채점',
    description:
      '정답일 때만 correctAnswer·explanation이 포함됩니다. 목록 API에는 정답이 없습니다.',
  })
  ...
  @ApiHeader({
    ...
    description: '중복 채점 카운트 방지용 요청 키',
    required: false,
  })
